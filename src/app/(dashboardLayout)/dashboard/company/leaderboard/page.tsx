...
const INITIAL_LEADERBOARD = [
  { id: "1", rank: 1, name: "Daniel Carter", email: "Daniel.Carter@gmail.com", company: "Alpha Fleet", standing: "Platinum", score: 93.8, change: "+8 From last week", isPositive: true },
  { id: "2", rank: 2, name: "Daniel Carter", email: "Daniel.Carter@gmail.com", company: "Alpha Fleet", standing: "Platinum", score: 93.8, change: "+5 From last week", isPositive: true },
  { id: "3", rank: 3, name: "Daniel Carter", email: "Daniel.Carter@gmail.com", company: "Alpha Fleet", standing: "Platinum", score: 93.8, change: "+8 From last week", isPositive: true },
  { id: "4", rank: 4, name: "Daniel Carter", email: "Daniel.Carter@gmail.com", company: "Alpha Fleet", standing: "Platinum", score: 93.8, change: "+6 From last week", isPositive: true },
  { id: "5", rank: 5, name: "Daniel Carter", email: "Daniel.Carter@gmail.com", company: "Alpha Fleet", standing: "Platinum", score: 93.8, change: "+5 From last week", isPositive: true },
  { id: "6", rank: 6, name: "Daniel Carter", email: "Daniel.Carter@gmail.com", company: "Alpha Fleet", standing: "Platinum", score: 93.8, change: "+8 From last week", isPositive: true },
  { id: "7", rank: 7, name: "Daniel Carter", email: "Daniel.Carter@gmail.com", company: "Alpha Fleet", standing: "Gold", score: 78.4, change: "-4 From last week", isPositive: false },
  { id: "8", rank: 8, name: "Daniel Carter", email: "Daniel.Carter@gmail.com", company: "Alpha Fleet", standing: "Gold", score: 78.4, change: "-8 From last week", isPositive: false },
  { id: "9", rank: 9, name: "Daniel Carter", email: "Daniel.Carter@gmail.com", company: "Alpha Fleet", standing: "Gold", score: 78.4, change: "-8 From last week", isPositive: false },
];
...
export default function CompanyLeaderboardPage() {
  ...
  const handleExportCSV = () => {
    const headers = ["Rank", "Driver Name", "Email", "Company Name", "Standing", "Score", "Change"];
  ...
  return (
    <div className="w-full space-y-6 font-poppins pb-12 select-text animate-fade-in">
      ...
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-base font-bold text-gray-900">Top 3 For This Week</h3>
        ...
        <div className="relative">
          ...
          >
            ...
            <ChevronDown className={`w-3.5 h-3.5 text-gray-400 transition-transform duration-200 ${weekDropdownOpen ? "rotate-180" : ""}`} />
          </button>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex items-center justify-between relative overflow-hidden">
          <div className="space-y-1 text-left">
            <div className="flex items-center gap-2">
              {/* Green circle with trophy */}
              <div className="w-10 h-10 rounded-full bg-[#008A45] flex items-center justify-center text-white shrink-0 shadow-sm">
                <Trophy className="w-5 h-5" />
              </div>
              <div className="text-left">
                <p className="text-sm font-black text-gray-900 leading-tight">Daniel Carter</p>
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-0.5">Champion</p>
              </div>
            </div>
            <p className="text-3xl font-black text-gray-900 leading-none pt-4">96.8</p>
          </div>
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex items-center justify-between relative overflow-hidden">
          <div className="space-y-1 text-left">
            <div className="flex items-center gap-2">
              {/* Orange circle with star/award */}
              <div className="w-10 h-10 rounded-full bg-[#FAAD14] flex items-center justify-center text-white shrink-0 shadow-sm">
                <Zap className="w-5 h-5" />
              </div>
              <div className="text-left">
                <p className="text-sm font-black text-gray-900 leading-tight">Daniel Carter</p>
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-0.5">Rising Star</p>
              </div>
            </div>
            <p className="text-3xl font-black text-gray-900 leading-none pt-4">93.8</p>
          </div>
        ...
        <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-all duration-300 flex items-center justify-between relative overflow-hidden">
          <div className="space-y-1 text-left">
            <div className="flex items-center gap-2">
              {/* Purple circle with trending up */}
              <div className="w-10 h-10 rounded-full bg-[#722ED1] flex items-center justify-center text-white shrink-0 shadow-sm">
                <Trophy className="w-5 h-5" />
              </div>
              <div className="text-left">
                <p className="text-sm font-black text-gray-900 leading-tight">Daniel Carter</p>
                <p className="text-[10px] text-gray-400 font-bold uppercase tracking-wider mt-0.5">Most Improved</p>
              </div>
            </div>
            <p className="text-3xl font-black text-gray-900 leading-none pt-4">91.8</p>
          </div>
      ...
      <div className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm">
        ...
        <div className="flex items-center justify-between mb-6">
          <h3 className="text-lg font-black text-gray-900">Current Week Leaderboard</h3>
            ...
            <tbody className="divide-y divide-gray-50 text-xs font-semibold text-gray-700">
              {paginatedLeaderboard.map((driver) => (
                <tr key={driver.id} className="hover:bg-gray-50/50 transition-colors">
                  {/* Rank */}
                  <td className="py-4 font-bold text-gray-550">{driver.rank}</td>
                  {/* Name */}
                  <td className="py-4">
                  ...
                  <td className="py-4 text-right pr-3">
                    <button 
                      ...
                      className="w-7 h-7 rounded-full border border-gray-200 hover:bg-gray-50 text-gray-400 hover:text-gray-650 flex items-center justify-center cursor-pointer transition-colors align-middle"
                    >
